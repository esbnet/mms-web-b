...
import Logo from '../../assets/logo-192x192B.png'

export default function Login() {
  return (
    <>
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 shadow-lg p-10">
          <div className="flex flex-col items-center justify-center">
            <Image src={Logo} alt="Workflow" className='antialiased' />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 mb text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                />
